...
public class CommentController {
    ...
    public ResponseEntity<Flux<CommentDto>> findAllComments(@PathVariable String bookId) {
    ...
    public ResponseEntity<CommentDto> updateComment(@PathVariable(required = true) String bookId,
                              @RequestBody CommentDto commentDto) {
        return null;//ResponseEntity.ok(commentService.update(commentDto.getId(), commentDto.getText(), commentDto.getBook()));
    }
