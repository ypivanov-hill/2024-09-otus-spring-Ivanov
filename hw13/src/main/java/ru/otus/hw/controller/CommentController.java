...
public class CommentController {
    ...
    @GetMapping("/comment")
    public String findAllComments(@RequestParam Long bookId, Model model) {
    ...
    public String addNewComments(@RequestParam Long bookId, Model model) {
    ...
    public String createComment(@RequestParam(required = true) Long bookId,
    ...
    public String editComment(@RequestParam(required = true) Long bookId, Model model) {
        addReferences(bookId, model);
        return "commentEdit";
    }

    @PostMapping("/comment/edit")
    public String editComment(@RequestParam(value = "id", defaultValue = "", required = false) List<Long> ids,
    ...
    @DeleteMapping("/comment/deleteById")
    public String deleteById(@RequestParam Long id, @RequestParam Long bookId, Model model) {
    ...
    private void addReferences(Long bookId, Model model) {
        BookDto book = bookService.findById(bookId)
                .orElseThrow(() -> new EntityNotFoundException("Book Entity Not Found"));
        model.addAttribute("book", book);
