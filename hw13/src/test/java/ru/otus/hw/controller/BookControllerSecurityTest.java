...
public class BookControllerSecurityTest {
    ...
    public static Stream<Arguments> getTestArguments() {
        ...
        return Stream.of(
                ...
                Arguments.of(HttpMethod.DELETE, "/deleteBookById/{id}", user, status().isOk(), false, LOGIN_URL, Map.of(), List.of(2).toArray()),
                Arguments.of(HttpMethod.POST, "/edit", user, status().isOk(), false, LOGIN_URL, paramMap, List.of().toArray()),
                Arguments.of(HttpMethod.GET, "/edit/{id}", user, status().isOk(), true, LOGIN_URL, Map.of(), List.of(1).toArray()),
